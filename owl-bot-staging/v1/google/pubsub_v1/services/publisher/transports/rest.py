...
class PublisherRestTransport(_BasePublisherRestTransport):
    ...
    class _CreateTopic(_BasePublisherRestTransport._BaseCreateTopic, PublisherRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BasePublisherRestTransport._BaseCreateTopic._get_http_options()
            request, metadata = self._interceptor.pre_create_topic(request, metadata)
            transcoded_request = _BasePublisherRestTransport._BaseCreateTopic._get_transcoded_request(http_options, request)

            body = _BasePublisherRestTransport._BaseCreateTopic._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BasePublisherRestTransport._BaseCreateTopic._get_query_params_json(transcoded_request)

            # Send the request
            response = PublisherRestTransport._CreateTopic._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteTopic(_BasePublisherRestTransport._BaseDeleteTopic, PublisherRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BasePublisherRestTransport._BaseDeleteTopic._get_http_options()
            request, metadata = self._interceptor.pre_delete_topic(request, metadata)
            transcoded_request = _BasePublisherRestTransport._BaseDeleteTopic._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePublisherRestTransport._BaseDeleteTopic._get_query_params_json(transcoded_request)

            # Send the request
            response = PublisherRestTransport._DeleteTopic._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DetachSubscription(_BasePublisherRestTransport._BaseDetachSubscription, PublisherRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BasePublisherRestTransport._BaseDetachSubscription._get_http_options()
            request, metadata = self._interceptor.pre_detach_subscription(request, metadata)
            transcoded_request = _BasePublisherRestTransport._BaseDetachSubscription._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePublisherRestTransport._BaseDetachSubscription._get_query_params_json(transcoded_request)

            # Send the request
            response = PublisherRestTransport._DetachSubscription._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetTopic(_BasePublisherRestTransport._BaseGetTopic, PublisherRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BasePublisherRestTransport._BaseGetTopic._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePublisherRestTransport._BaseGetTopic._get_query_params_json(transcoded_request)

            # Send the request
            response = PublisherRestTransport._GetTopic._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListTopics(_BasePublisherRestTransport._BaseListTopics, PublisherRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BasePublisherRestTransport._BaseListTopics._get_http_options()
            request, metadata = self._interceptor.pre_list_topics(request, metadata)
            transcoded_request = _BasePublisherRestTransport._BaseListTopics._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePublisherRestTransport._BaseListTopics._get_query_params_json(transcoded_request)

            # Send the request
            response = PublisherRestTransport._ListTopics._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListTopicSnapshots(_BasePublisherRestTransport._BaseListTopicSnapshots, PublisherRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BasePublisherRestTransport._BaseListTopicSnapshots._get_http_options()
            request, metadata = self._interceptor.pre_list_topic_snapshots(request, metadata)
            transcoded_request = _BasePublisherRestTransport._BaseListTopicSnapshots._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePublisherRestTransport._BaseListTopicSnapshots._get_query_params_json(transcoded_request)

            # Send the request
            response = PublisherRestTransport._ListTopicSnapshots._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListTopicSubscriptions(_BasePublisherRestTransport._BaseListTopicSubscriptions, PublisherRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BasePublisherRestTransport._BaseListTopicSubscriptions._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePublisherRestTransport._BaseListTopicSubscriptions._get_query_params_json(transcoded_request)

            # Send the request
            response = PublisherRestTransport._ListTopicSubscriptions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateTopic(_BasePublisherRestTransport._BaseUpdateTopic, PublisherRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BasePublisherRestTransport._BaseUpdateTopic._get_http_options()
            request, metadata = self._interceptor.pre_update_topic(request, metadata)
            transcoded_request = _BasePublisherRestTransport._BaseUpdateTopic._get_transcoded_request(http_options, request)

            body = _BasePublisherRestTransport._BaseUpdateTopic._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BasePublisherRestTransport._BaseUpdateTopic._get_query_params_json(transcoded_request)

            # Send the request
            response = PublisherRestTransport._UpdateTopic._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetIamPolicy(_BasePublisherRestTransport._BaseGetIamPolicy, PublisherRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BasePublisherRestTransport._BaseGetIamPolicy._get_http_options()
            request, metadata = self._interceptor.pre_get_iam_policy(request, metadata)
            transcoded_request = _BasePublisherRestTransport._BaseGetIamPolicy._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePublisherRestTransport._BaseGetIamPolicy._get_query_params_json(transcoded_request)

            # Send the request
            response = PublisherRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SetIamPolicy(_BasePublisherRestTransport._BaseSetIamPolicy, PublisherRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BasePublisherRestTransport._BaseSetIamPolicy._get_http_options()
            request, metadata = self._interceptor.pre_set_iam_policy(request, metadata)
            transcoded_request = _BasePublisherRestTransport._BaseSetIamPolicy._get_transcoded_request(http_options, request)

            body = _BasePublisherRestTransport._BaseSetIamPolicy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BasePublisherRestTransport._BaseSetIamPolicy._get_query_params_json(transcoded_request)

            # Send the request
            response = PublisherRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BasePublisherRestTransport._BaseTestIamPermissions, PublisherRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BasePublisherRestTransport._BaseTestIamPermissions._get_http_options()
            request, metadata = self._interceptor.pre_test_iam_permissions(request, metadata)
            transcoded_request = _BasePublisherRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            body = _BasePublisherRestTransport._BaseTestIamPermissions._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BasePublisherRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)

            # Send the request
            response = PublisherRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
