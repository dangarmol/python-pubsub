...
class SchemaServiceRestTransport(_BaseSchemaServiceRestTransport):
    ...
    class _CommitSchema(_BaseSchemaServiceRestTransport._BaseCommitSchema, SchemaServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSchemaServiceRestTransport._BaseCommitSchema._get_http_options()
            request, metadata = self._interceptor.pre_commit_schema(request, metadata)
            transcoded_request = _BaseSchemaServiceRestTransport._BaseCommitSchema._get_transcoded_request(http_options, request)

            body = _BaseSchemaServiceRestTransport._BaseCommitSchema._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSchemaServiceRestTransport._BaseCommitSchema._get_query_params_json(transcoded_request)

            # Send the request
            response = SchemaServiceRestTransport._CommitSchema._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteSchemaRevision(_BaseSchemaServiceRestTransport._BaseDeleteSchemaRevision, SchemaServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseSchemaServiceRestTransport._BaseDeleteSchemaRevision._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSchemaServiceRestTransport._BaseDeleteSchemaRevision._get_query_params_json(transcoded_request)

            # Send the request
            response = SchemaServiceRestTransport._DeleteSchemaRevision._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListSchemaRevisions(_BaseSchemaServiceRestTransport._BaseListSchemaRevisions, SchemaServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseSchemaServiceRestTransport._BaseListSchemaRevisions._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSchemaServiceRestTransport._BaseListSchemaRevisions._get_query_params_json(transcoded_request)

            # Send the request
            response = SchemaServiceRestTransport._ListSchemaRevisions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _RollbackSchema(_BaseSchemaServiceRestTransport._BaseRollbackSchema, SchemaServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSchemaServiceRestTransport._BaseRollbackSchema._get_http_options()
            request, metadata = self._interceptor.pre_rollback_schema(request, metadata)
            transcoded_request = _BaseSchemaServiceRestTransport._BaseRollbackSchema._get_transcoded_request(http_options, request)

            body = _BaseSchemaServiceRestTransport._BaseRollbackSchema._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSchemaServiceRestTransport._BaseRollbackSchema._get_query_params_json(transcoded_request)

            # Send the request
            response = SchemaServiceRestTransport._RollbackSchema._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ValidateMessage(_BaseSchemaServiceRestTransport._BaseValidateMessage, SchemaServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSchemaServiceRestTransport._BaseValidateMessage._get_http_options()
            request, metadata = self._interceptor.pre_validate_message(request, metadata)
            transcoded_request = _BaseSchemaServiceRestTransport._BaseValidateMessage._get_transcoded_request(http_options, request)

            body = _BaseSchemaServiceRestTransport._BaseValidateMessage._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSchemaServiceRestTransport._BaseValidateMessage._get_query_params_json(transcoded_request)

            # Send the request
            response = SchemaServiceRestTransport._ValidateMessage._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ValidateSchema(_BaseSchemaServiceRestTransport._BaseValidateSchema, SchemaServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSchemaServiceRestTransport._BaseValidateSchema._get_http_options()
            request, metadata = self._interceptor.pre_validate_schema(request, metadata)
            transcoded_request = _BaseSchemaServiceRestTransport._BaseValidateSchema._get_transcoded_request(http_options, request)

            body = _BaseSchemaServiceRestTransport._BaseValidateSchema._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSchemaServiceRestTransport._BaseValidateSchema._get_query_params_json(transcoded_request)

            # Send the request
            response = SchemaServiceRestTransport._ValidateSchema._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetIamPolicy(_BaseSchemaServiceRestTransport._BaseGetIamPolicy, SchemaServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSchemaServiceRestTransport._BaseGetIamPolicy._get_http_options()
            request, metadata = self._interceptor.pre_get_iam_policy(request, metadata)
            transcoded_request = _BaseSchemaServiceRestTransport._BaseGetIamPolicy._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSchemaServiceRestTransport._BaseGetIamPolicy._get_query_params_json(transcoded_request)

            # Send the request
            response = SchemaServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SetIamPolicy(_BaseSchemaServiceRestTransport._BaseSetIamPolicy, SchemaServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSchemaServiceRestTransport._BaseSetIamPolicy._get_http_options()
            request, metadata = self._interceptor.pre_set_iam_policy(request, metadata)
            transcoded_request = _BaseSchemaServiceRestTransport._BaseSetIamPolicy._get_transcoded_request(http_options, request)

            body = _BaseSchemaServiceRestTransport._BaseSetIamPolicy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSchemaServiceRestTransport._BaseSetIamPolicy._get_query_params_json(transcoded_request)

            # Send the request
            response = SchemaServiceRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseSchemaServiceRestTransport._BaseTestIamPermissions, SchemaServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseSchemaServiceRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            body = _BaseSchemaServiceRestTransport._BaseTestIamPermissions._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSchemaServiceRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)

            # Send the request
            response = SchemaServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
