...
class SubscriberRestTransport(_BaseSubscriberRestTransport):
    ...
    class _Acknowledge(_BaseSubscriberRestTransport._BaseAcknowledge, SubscriberRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSubscriberRestTransport._BaseAcknowledge._get_http_options()
            request, metadata = self._interceptor.pre_acknowledge(request, metadata)
            transcoded_request = _BaseSubscriberRestTransport._BaseAcknowledge._get_transcoded_request(http_options, request)

            body = _BaseSubscriberRestTransport._BaseAcknowledge._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSubscriberRestTransport._BaseAcknowledge._get_query_params_json(transcoded_request)

            # Send the request
            response = SubscriberRestTransport._Acknowledge._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CreateSnapshot(_BaseSubscriberRestTransport._BaseCreateSnapshot, SubscriberRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSubscriberRestTransport._BaseCreateSnapshot._get_http_options()
            request, metadata = self._interceptor.pre_create_snapshot(request, metadata)
            transcoded_request = _BaseSubscriberRestTransport._BaseCreateSnapshot._get_transcoded_request(http_options, request)

            body = _BaseSubscriberRestTransport._BaseCreateSnapshot._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSubscriberRestTransport._BaseCreateSnapshot._get_query_params_json(transcoded_request)

            # Send the request
            response = SubscriberRestTransport._CreateSnapshot._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CreateSubscription(_BaseSubscriberRestTransport._BaseCreateSubscription, SubscriberRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSubscriberRestTransport._BaseCreateSubscription._get_http_options()
            request, metadata = self._interceptor.pre_create_subscription(request, metadata)
            transcoded_request = _BaseSubscriberRestTransport._BaseCreateSubscription._get_transcoded_request(http_options, request)

            body = _BaseSubscriberRestTransport._BaseCreateSubscription._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSubscriberRestTransport._BaseCreateSubscription._get_query_params_json(transcoded_request)

            # Send the request
            response = SubscriberRestTransport._CreateSubscription._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteSnapshot(_BaseSubscriberRestTransport._BaseDeleteSnapshot, SubscriberRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSubscriberRestTransport._BaseDeleteSnapshot._get_http_options()
            request, metadata = self._interceptor.pre_delete_snapshot(request, metadata)
            transcoded_request = _BaseSubscriberRestTransport._BaseDeleteSnapshot._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSubscriberRestTransport._BaseDeleteSnapshot._get_query_params_json(transcoded_request)

            # Send the request
            response = SubscriberRestTransport._DeleteSnapshot._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteSubscription(_BaseSubscriberRestTransport._BaseDeleteSubscription, SubscriberRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSubscriberRestTransport._BaseDeleteSubscription._get_http_options()
            request, metadata = self._interceptor.pre_delete_subscription(request, metadata)
            transcoded_request = _BaseSubscriberRestTransport._BaseDeleteSubscription._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSubscriberRestTransport._BaseDeleteSubscription._get_query_params_json(transcoded_request)

            # Send the request
            response = SubscriberRestTransport._DeleteSubscription._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetSnapshot(_BaseSubscriberRestTransport._BaseGetSnapshot, SubscriberRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSubscriberRestTransport._BaseGetSnapshot._get_http_options()
            request, metadata = self._interceptor.pre_get_snapshot(request, metadata)
            transcoded_request = _BaseSubscriberRestTransport._BaseGetSnapshot._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSubscriberRestTransport._BaseGetSnapshot._get_query_params_json(transcoded_request)

            # Send the request
            response = SubscriberRestTransport._GetSnapshot._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetSubscription(_BaseSubscriberRestTransport._BaseGetSubscription, SubscriberRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSubscriberRestTransport._BaseGetSubscription._get_http_options()
            request, metadata = self._interceptor.pre_get_subscription(request, metadata)
            transcoded_request = _BaseSubscriberRestTransport._BaseGetSubscription._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSubscriberRestTransport._BaseGetSubscription._get_query_params_json(transcoded_request)

            # Send the request
            response = SubscriberRestTransport._GetSubscription._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListSnapshots(_BaseSubscriberRestTransport._BaseListSnapshots, SubscriberRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSubscriberRestTransport._BaseListSnapshots._get_http_options()
            request, metadata = self._interceptor.pre_list_snapshots(request, metadata)
            transcoded_request = _BaseSubscriberRestTransport._BaseListSnapshots._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSubscriberRestTransport._BaseListSnapshots._get_query_params_json(transcoded_request)

            # Send the request
            response = SubscriberRestTransport._ListSnapshots._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListSubscriptions(_BaseSubscriberRestTransport._BaseListSubscriptions, SubscriberRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSubscriberRestTransport._BaseListSubscriptions._get_http_options()
            request, metadata = self._interceptor.pre_list_subscriptions(request, metadata)
            transcoded_request = _BaseSubscriberRestTransport._BaseListSubscriptions._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSubscriberRestTransport._BaseListSubscriptions._get_query_params_json(transcoded_request)

            # Send the request
            response = SubscriberRestTransport._ListSubscriptions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ModifyAckDeadline(_BaseSubscriberRestTransport._BaseModifyAckDeadline, SubscriberRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSubscriberRestTransport._BaseModifyAckDeadline._get_http_options()
            request, metadata = self._interceptor.pre_modify_ack_deadline(request, metadata)
            transcoded_request = _BaseSubscriberRestTransport._BaseModifyAckDeadline._get_transcoded_request(http_options, request)

            body = _BaseSubscriberRestTransport._BaseModifyAckDeadline._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSubscriberRestTransport._BaseModifyAckDeadline._get_query_params_json(transcoded_request)

            # Send the request
            response = SubscriberRestTransport._ModifyAckDeadline._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ModifyPushConfig(_BaseSubscriberRestTransport._BaseModifyPushConfig, SubscriberRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSubscriberRestTransport._BaseModifyPushConfig._get_http_options()
            request, metadata = self._interceptor.pre_modify_push_config(request, metadata)
            transcoded_request = _BaseSubscriberRestTransport._BaseModifyPushConfig._get_transcoded_request(http_options, request)

            body = _BaseSubscriberRestTransport._BaseModifyPushConfig._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSubscriberRestTransport._BaseModifyPushConfig._get_query_params_json(transcoded_request)

            # Send the request
            response = SubscriberRestTransport._ModifyPushConfig._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _Pull(_BaseSubscriberRestTransport._BasePull, SubscriberRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseSubscriberRestTransport._BasePull._get_transcoded_request(http_options, request)

            body = _BaseSubscriberRestTransport._BasePull._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSubscriberRestTransport._BasePull._get_query_params_json(transcoded_request)

            # Send the request
            response = SubscriberRestTransport._Pull._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _Seek(_BaseSubscriberRestTransport._BaseSeek, SubscriberRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseSubscriberRestTransport._BaseSeek._get_transcoded_request(http_options, request)

            body = _BaseSubscriberRestTransport._BaseSeek._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSubscriberRestTransport._BaseSeek._get_query_params_json(transcoded_request)

            # Send the request
            response = SubscriberRestTransport._Seek._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _StreamingPull(_BaseSubscriberRestTransport._BaseStreamingPull, SubscriberRestStub):
        def __hash__(self):
    ...
    class _UpdateSnapshot(_BaseSubscriberRestTransport._BaseUpdateSnapshot, SubscriberRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSubscriberRestTransport._BaseUpdateSnapshot._get_http_options()
            request, metadata = self._interceptor.pre_update_snapshot(request, metadata)
            transcoded_request = _BaseSubscriberRestTransport._BaseUpdateSnapshot._get_transcoded_request(http_options, request)

            body = _BaseSubscriberRestTransport._BaseUpdateSnapshot._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSubscriberRestTransport._BaseUpdateSnapshot._get_query_params_json(transcoded_request)

            # Send the request
            response = SubscriberRestTransport._UpdateSnapshot._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateSubscription(_BaseSubscriberRestTransport._BaseUpdateSubscription, SubscriberRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSubscriberRestTransport._BaseUpdateSubscription._get_http_options()
            request, metadata = self._interceptor.pre_update_subscription(request, metadata)
            transcoded_request = _BaseSubscriberRestTransport._BaseUpdateSubscription._get_transcoded_request(http_options, request)

            body = _BaseSubscriberRestTransport._BaseUpdateSubscription._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSubscriberRestTransport._BaseUpdateSubscription._get_query_params_json(transcoded_request)

            # Send the request
            response = SubscriberRestTransport._UpdateSubscription._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetIamPolicy(_BaseSubscriberRestTransport._BaseGetIamPolicy, SubscriberRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSubscriberRestTransport._BaseGetIamPolicy._get_http_options()
            request, metadata = self._interceptor.pre_get_iam_policy(request, metadata)
            transcoded_request = _BaseSubscriberRestTransport._BaseGetIamPolicy._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSubscriberRestTransport._BaseGetIamPolicy._get_query_params_json(transcoded_request)

            # Send the request
            response = SubscriberRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SetIamPolicy(_BaseSubscriberRestTransport._BaseSetIamPolicy, SubscriberRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSubscriberRestTransport._BaseSetIamPolicy._get_http_options()
            request, metadata = self._interceptor.pre_set_iam_policy(request, metadata)
            transcoded_request = _BaseSubscriberRestTransport._BaseSetIamPolicy._get_transcoded_request(http_options, request)

            body = _BaseSubscriberRestTransport._BaseSetIamPolicy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSubscriberRestTransport._BaseSetIamPolicy._get_query_params_json(transcoded_request)

            # Send the request
            response = SubscriberRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseSubscriberRestTransport._BaseTestIamPermissions, SubscriberRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseSubscriberRestTransport._BaseTestIamPermissions._get_http_options()
            request, metadata = self._interceptor.pre_test_iam_permissions(request, metadata)
            transcoded_request = _BaseSubscriberRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            body = _BaseSubscriberRestTransport._BaseTestIamPermissions._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSubscriberRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)

            # Send the request
            response = SubscriberRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
